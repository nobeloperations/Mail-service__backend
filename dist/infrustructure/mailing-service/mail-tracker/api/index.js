...
const track_mail_opening_route_1 = __importDefault(require("./routes/track-mail-opening.route"));
const maiing_unsubscriber_router_1 = __importDefault(require("./routes/maiing-unsubscriber.router"));
const router = (0, express_1.default)();
router.use('/track-mail-opening', track_mail_opening_route_1.default);
